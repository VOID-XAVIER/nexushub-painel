...
export default function MasterDashboard() {
  const { getStats, getUsersByRole } = useData();
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <StatCard
          ...
          color="emerald"
          subtitle={`${stats.inactiveCompanies} inativas`}
          icon={
            <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <StatCard
          ...
          value={stats.totalMasterStaff}
          color="amber"
          subtitle="Master Staff"
          icon={
            <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-800">
          <h2 className="text-lg font-semibold text-white">Equipe Master</h2>
        </div>
            ...
            masterStaff.map((member) => (
              <div key={member.id} className="px-6 py-4 flex items-center justify-between">
                ...
                <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${
                  ...
                  <span className={`w-1.5 h-1.5 rounded-full ${member.isOnline ? 'bg-emerald-400' : 'bg-gray-400'}`} />
